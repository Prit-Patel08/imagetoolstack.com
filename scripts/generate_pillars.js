...
const pillarPages = [
  { slug: "image-formats", title: "The Ultimate Guide to Image Formats" },
  { slug: "image-converter", title: "Free Online Image Converter" },
  { slug: "image-compressor", title: "The Best Free Image Compressor" },
  { slug: "resize-image-online", title: "How to Resize Images Online Free" },
  { slug: "crop-image-online", title: "Crop Images Online Instantly" },
  { slug: "remove-background-online", title: "Remove Image Backgrounds Online" },
  { slug: "image-tools", title: "The Ultimate Suite of Image Tools" },
  { slug: "free-image-tools", title: "100% Free Image Tools" },
  { slug: "online-image-tools", title: "The Best Online Image Tools" },
  { slug: "browser-based-image-tools", title: "Secure Browser-Based Image Tools" }
];

pillarPages.forEach(p => {
  const content = `---
title: "${p.title}"
description: "Everything you need to know about ${p.slug.replace(/-/g, ' ')}. Read our definitive guide and access our free suite of privacy-first, browser-based tools."
pubDate: "2024-01-01"
---

Welcome to the definitive guide on **${p.slug.replace(/-/g, ' ')}**. 
...
`;
  ...
  fs.writeFileSync(path.join(articlesDir, `${p.slug}.md`), content);
});

console.log("Generated 10 pillar pages!");
